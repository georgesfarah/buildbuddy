...
class RepoItem extends React.Component<RepoItemProps, RepoItemState> {
  ...
  private onClickUpdateDefaultConfig(updated: boolean) {
    ...
    this.setState({ useDefaultWorkflowConfig: updated, updatingRepoSettings: true });
    ...
    rpcService.service
      ...
      .finally(() => this.setState({ updatingRepoSettings: false }));
  }
